<template>
	<view class="login">
		<view class="content">
			...
			<!-- 主体表单 -->
			<view class="main"><wInput v-model="login.username" type="text" maxlength="11" placeholder="手机号"></wInput></view>
			<wButton text="重 新 登 录" :rotate="isRotate" @click.native="startLogin()" class="wbutton"></wButton>
		</view>
	</view>
</template>
...
export default {
	...
	onLoad(user) {
		...
		this.login.refreshToken = uni.getStorageSync('refresh_token');
	},
	onBackPress(e) {
